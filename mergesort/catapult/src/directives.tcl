...
solution file add ./mergesort.cpp -type C++
...
go new
directive set -DESIGN_HIERARCHY mergesort
go compile
...
go assembly
directive set /mergesort/core/loop_LMM -UNROLL 2
directive set /mergesort/core/loop1 -UNROLL 2
directive set /mergesort/core/loop2 -UNROLL 2
directive set /mergesort/core/loop6 -UNROLL 2
directive set /mergesort/core/loop7 -UNROLL 2
go architect
go extract
