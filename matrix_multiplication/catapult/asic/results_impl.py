...
def main():
    ...
    file1.write("n"+","+"knob_KNOB_MAT_SIZE"+","+"knob_KNOB_UNROLL_L1"+","+"knob_KNOB_UNROLL_L2"+","+"knob_KNOB_UNROLL_L3"+","+"SUBDIM_X"+","+"SUBDIM_Y"+","+"knob_I_B"+","+"knob_KNOB_DATA_BLOCK_INTERLEAVE"+","+"Latency"+","+"Area"+"\n")
