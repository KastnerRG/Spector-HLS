...
directive set /histogram_hls/core/LOAD_MEM_MAIN -UNROLL 2
directive set /histogram_hls/core/loop_2 -UNROLL 2
directive set /histogram_hls/core/loop_3 -UNROLL 2
directive set /histogram_hls/core/mem.data:rsc BLOCK_SIZE 65536
go assembly
go extract
