...
directive set /histogram_hls/core/LOAD_MEM_MAIN -UNROLL 1
directive set /histogram_hls/core/loop_2 -UNROLL 1
directive set /histogram_hls/core/loop_3 -UNROLL 1
directive set /histogram_hls/core/mem.data:rsc BLOCK_SIZE 16384
go assembly
go extract
