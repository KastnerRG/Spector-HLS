ifeq "$(CXX_HOME)" ""
CXX_HOME                                            := /usr/local/bin/Mentor_Graphics/Catapult_Synthesis_10.4-828904/Mgc_home
export CXX_HOME
endif
ifeq "$(CXX_TYPE)" ""
CXX_TYPE                                            := gcc
...
OSCI_SYSTEMC_INCLUDE                                := /usr/local/bin/Mentor_Graphics/Catapult_Synthesis_10.4-828904/Mgc_home/shared/include
export OSCI_SYSTEMC_INCLUDE
endif
ifeq "$(OSCI_SYSTEMC_LIB)" ""
OSCI_SYSTEMC_LIB                                    := /usr/local/bin/Mentor_Graphics/Catapult_Synthesis_10.4-828904/Mgc_home/shared/lib/$(CXX_OS)/$(CXX_TYPE)
...
Vivado_XILINX_VIVADO                                := /tools/Xilinx/Vivado/2019.1
