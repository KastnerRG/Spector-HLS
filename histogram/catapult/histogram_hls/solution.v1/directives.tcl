...
//  
//  Running on Linux mdk@mdk-FX504 5.0.0-31-generic x86_64 aol
//  
...
solution file add ./histogram_main.cpp -type C++
solution file add ./histogram_tb.cpp -type C++ -exclude true
solution file add ./histogram.h -type CHEADER
solution file add ./params.h -type CHEADER
