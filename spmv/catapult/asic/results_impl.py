...
def main():
    ...
    file1=open('asic_catapult_spmv_area.csv','w')
    file1.write("n"+","+"knob_UNROLL_F"+","+"knob_outer_unroll"+","+"knob_inner_unroll1"+","+"knob_inner_unroll2"+","+"knob_array_part1"+","+"knob_array_part2"+","+"knob_I_B"+","+"obj1"+","+"obj2"+","+"FF"+"\n")
