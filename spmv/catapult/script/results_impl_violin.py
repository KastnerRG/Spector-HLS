...
def main():
    ...
    file1=open('catapult_spmv_area_violin.csv','w')
    ...
    for d in sorted(glob.glob('impl_reports/spmv_export*.xml')):
        ...
        file1.write("Throughput"+","+str(lat)+","+"catapult"+","+"CLB"+","+str(slices)+","+"FF"+","+str(ff)+","+"asic_fpga_area"+"\n")
        file1.write("Throughput"+","+str(lat)+","+"catapult"+","+"LUT"+","+str(lut)+","+"FF"+","+str(ff)+","+"asic_fpga_area"+"\n")
        file1.write("Throughput"+","+str(lat)+","+"catapult"+","+"FF"+","+str(ff)+","+"FF"+","+str(ff)+","+"asic_fpga_area"+"\n")
        file1.write("Throughput"+","+str(lat)+","+"catapult"+","+"DSP"+","+str(dsp)+","+"FF"+","+str(ff)+","+"asic_fpga_area"+"\n")
        file1.write("Throughput"+","+str(lat)+","+"catapult"+","+"BRAM"+","+str(bram)+","+"FF"+","+str(ff)+","+"asic_fpga_area"+"\n")
    file1.close()
