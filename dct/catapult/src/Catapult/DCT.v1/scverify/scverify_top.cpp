...
public:
  ...
  scverify_top(const sc_module_name& name)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 256442625, 256442625, 0)
    , catapult_monitor_INST("Monitor", clk, true, 256442625LL, 256442625LL)
...
void scverify_top::deadlock_watch() {
  ...
  if (!clk) {
    if (rst == SC_LOGIC_0 &&
      ...
      deadlock_event.notify(23079836080, SC_NS);
    } else {
