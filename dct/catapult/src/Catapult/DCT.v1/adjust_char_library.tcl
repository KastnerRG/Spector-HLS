...
#library load /usr/local/bin/Mentor_Graphics/Catapult_Synthesis_10.4b-841621/Mgc_home/pkgs/ccs_xilinx/mgc_Xilinx-VIRTEX-uplus-2_beh.lib
library set /LIBS/mgc_Xilinx-VIRTEX-uplus-2_beh/MODS/mgc_mux1hot/PARAMETERS/ctrlw -- -CHAR_RANGE {1, 4 to 32}
library set /LIBS/mgc_Xilinx-VIRTEX-uplus-2_beh/MODS/mgc_mux1hot/PARAMETERS/width -- -CHAR_RANGE {1, 4 to 32}
