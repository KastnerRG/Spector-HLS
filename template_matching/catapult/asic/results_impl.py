...
def main():
    ...
    file1.write("n"+","+"knob_tmpdim"+","+"knob_indim"+","+"knob_UNROLL_FACTOR"+","+"knob_UNROLL_LOOP1"+","+"knob_UNROLL_LOOP2"+","+"knob_UNROLL_LOOP3"+","+"knob_UNROLL_LOOP4"+","+"knob_tmpsize"+","+"knob_size"+","+"knob_I_B"+","+"Latency"+","+"Area"+"\n")
